...
describe("NFTMarketplace", function () {
  ...
  describe("Purchasing marketplace items", function () {
    ...
    it("Should update item as sold, pay seller, transfer NFT to buyer, charge fees and emit a Bought event", async function () {
      ...
      console.log("sellerInitalEthBal-->", fromWei(sellerInitalEthBal));
      console.log("feeAccountInitialEthBal-->", fromWei(feeAccountInitialEthBal));
      ...
      console.log("sellerFinalEthBal-->", fromWei(sellerFinalEthBal));
      console.log("feeAccountFinalEthBal-->", fromWei(feeAccountFinalEthBal));
